...
-- Materializa o pedido do RAFAEL (R$ 13,50) cujo pagamento já foi aprovado
SELECT public.materializar_pedido_pendente(
  'c714cb1e-98d3-424a-9e71-4776eead9168'::uuid,
  '165906821882',
  'approved'
);
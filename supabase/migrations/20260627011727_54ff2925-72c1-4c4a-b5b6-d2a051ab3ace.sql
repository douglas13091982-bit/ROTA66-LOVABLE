...
-- Função enxuta: cria/preenche profile a partir do metadata do signup
...
BEGIN
  BEGIN
    _tipo_veic := COALESCE(_tipo::public.tipo_veiculo, NULL);
  ...
  ON CONFLICT (id) DO UPDATE SET
    ...
    tipo_veiculo = COALESCE(public.profiles.tipo_veiculo,          EXCLUDED.tipo_veiculo),
...
CREATE TRIGGER on_auth_user_created_create_profile
  ...
  FOR EACH ROW
  EXECUTE FUNCTION public.create_profile_from_signup();

...
type Props = { entregador: AdminEntregadorItem };

export function EntregadorRealtimeCard({ entregador: e }: Props) {
  return (
    <div
    ...
    >
      <div className="relative shrink-0">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, oklch(0.62 0.22 27), oklch(0.42 0.20 27))",
          }}
        >

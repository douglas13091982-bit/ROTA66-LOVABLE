...
import { useEntregadoresLista } from "../hooks/use-entregadores-lista";
import { EntregadorRealtimeCard } from "./EntregadorRealtimeCard";

export function EntregadoresListaAdmin() {
      ...
      <div className="p-4">
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {data.map((e) => (
              <EntregadorRealtimeCard key={e.id} entregador={e} />
            ))}
          </div>
        )}
      </div>

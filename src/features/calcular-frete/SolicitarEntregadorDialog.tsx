  ...
  return (
    <label className="block">
      ...
      <input
        ...
        maxLength={maxLength}
        className="w-full mt-1 px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-slate-500"
      />
    </label>
  );
}

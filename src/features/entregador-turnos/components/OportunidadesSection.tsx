...
export function OportunidadesSection({ loading, disponiveis, onAceitar }: Props) {
  return (
    <section>
      <h2 className="font-display text-xl mb-3 flex items-center justify-center gap-2 text-center !text-white">
        <CalendarClock className="h-5 w-5 !text-white" /> Oportunidades disponíveis
      </h2>

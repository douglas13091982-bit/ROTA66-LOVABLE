    ...
    >
      ...
      <div className="relative flex items-center gap-3 px-4 py-4">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-[16px] font-black !text-white uppercase tracking-tight truncate leading-tight">
            {principal.loja_nome || "Loja"}
          </h3>
          <p className="text-[12px] font-semibold uppercase tracking-wide mt-0.5 truncate !text-white/75">
        ...
        <div className="text-right shrink-0">
          ...
          <p className="text-[22px] font-black !text-white tracking-tight tabular-nums leading-none mt-0.5">

      ...
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ...
          style={{
            ...
            translate: "none",
            transform: "none",
            width: "calc(100svw - 1rem - env(safe-area-inset-left) - env(safe-area-inset-right))",
            maxWidth: "min(42rem, calc(100svw - 1rem - env(safe-area-inset-left) - env(safe-area-inset-right)))",
            maxHeight: "calc(100svh - 1rem - env(safe-area-inset-top) - env(safe-area-inset-bottom))",

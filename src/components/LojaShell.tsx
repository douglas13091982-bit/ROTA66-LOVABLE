  ...
  return (
    <div className="panel-premium panel-light flex">
      ...
      <div className="flex-1 flex flex-col min-w-0 relative">
        ...
        >
          <button
            className="md:hidden h-9 w-9 grid place-items-center bg-[#e3000f] hover:bg-[#8d0000] !text-white transition"
          ...
          <button
            className="hidden md:grid h-9 w-9 place-items-center bg-[#e3000f] hover:bg-[#8d0000] !text-white transition"
            onClick={toggleCollapsed}
            aria-label={collapsed ? "Expandir menu" : "Recolher menu"}
            title={collapsed ? "Expandir menu" : "Recolher menu"}
          >
